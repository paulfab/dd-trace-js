  ...
  describe('ASM_DATA remote config', () => {
    ...
    describe('enable', () => {
      it('should not fail if remote config is not enabled before', () => {
        config.appsec = {}
        remoteConfig.enableAsmData(config.appsec)
        expect(rc.updateCapabilities).to.not.be.calledWith(RemoteConfigCapabilities.ASM_IP_BLOCKING, true)
      ...
      it('should activate if appsec is manually enabled', () => {
        ...
        remoteConfig.enable(config)
        remoteConfig.enableAsmData(config.appsec)
        expect(rc.updateCapabilities).to.be.calledOnceWith(RemoteConfigCapabilities.ASM_IP_BLOCKING, true)
      ...
      it('should activate if appsec enabled is not defined', () => {
        ...
        remoteConfig.enable(config)
        remoteConfig.enableAsmData(config.appsec)
        expect(rc.updateCapabilities).to.be.calledWith(RemoteConfigCapabilities.ASM_IP_BLOCKING, true)
    ...
    describe('disable', () => {
      it('should update capabilities and unsubscribe listener', () => {
        ...
        expect(rc.updateCapabilities).to.have.been.calledOnceWith(RemoteConfigCapabilities.ASM_IP_BLOCKING, false)
